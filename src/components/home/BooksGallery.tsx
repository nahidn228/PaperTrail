...
const BooksGallery: React.FC<Props> = ({ items }) => {
  ...
  return (
    <section className="py-32 container max-w-screen mx-auto ">
        ...
        <div className="mb-8 flex items-end justify-between md:mb-14 lg:mb-16">
          <div className="flex flex-col gap-4">
            ...
            <p className="max-w-lg text-muted-foreground">
              Discover, organize, and share your favorite books effortlessly.
              Dive into a curated reading journey with PaperTrail.
            </p>
          </div>
